...
@Component
public class AdminReplyKeyboardMaker {

    private final UserService userService;

    public AdminReplyKeyboardMaker(UserService userService) {
    ...
    public ReplyKeyboardMarkup getMainMenuKeyboard(Long userId) {
        ...
        if (user.getIsAdmin()) {
            ...
            row1.add(new KeyboardButton(ButtonNameEnum.GET_TASKS.getButtonName()));
            row1.add(new KeyboardButton(ButtonNameEnum.UPLOAD_TASKS.getButtonName()));

            KeyboardRow row2 = new KeyboardRow();
            row2.add(new KeyboardButton(ButtonNameEnum.ALL_USERS.getButtonName()));
